...
public:
    ...
    void set_buffers(int num_gaussians, float* mean_data, float* rot_data, float* scale_data, float* alpha_data, float* color_data) const;
...
private:
    ...
    constexpr auto buffer_count() const { return &_bufferCount - &meanBuffer; }
};
